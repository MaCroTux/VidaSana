      ...
      <div class="row">
        <div class="col-md-12">
          <div class="page-header">
        	  <h2><a class="btn btn-default" href="/" role="button"><i class="glyphicon glyphicon-chevron-left"></i></a> ¿Sabes que comes? <small>Lista de aditivos alimentarios</small></h2>
        	</div>
              ...
              <tbody>
                <?php
                  ...
                  foreach($db AS $item){
                      ...
                      echo "<tr><td>".'<a href="#" data-toggle="modal" data-target="#ficha'.$item['numero'].'">'.$item['numero']."</a></td><td>".$item['nombre']."</td><td>".'<span class="label label-'.$color.'">'.$item['toxico'].'</span>'."</td></tr>";
                      $modal[] = '<!-- Modal -->
